		...
		<script type="text/javascript">
			$(function(){
				...
				$("#qnaUpdateBtn").click(function(){
					...
					else if(!chkData("#qna_content", "작성할 내용을")) return;
					else{
						$("#f_updateForm").attr({
							"method" : "post",
	...
	<body>
		<div class="contentContainer container">
				...
				<form id="f_updateForm" name="f_updateForm">
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								<td>글번호</td>
								<td class="text-left">${updateData.qna_no}</td>
								<td>작성일</td>
								<td class="text-left">${updateData.qna_writeday}</td>
							</tr>
							<tr>
								<td>글제목</td>
								<td colspan="3" class="text-left">
									<input type="text" name="qna_title" id="qna_title" value="${updateData.qna_title}" class="form-control"/>
								</td>
							</tr>
							<tr>
								<td>작성자</td>
								<td colspan="3" class="text-left">${updateData.qna_name}</td>
							</tr>
							<tr class="table-height">
								<td>내용</td>
								<td colspan="3" class="text-left">
									<textarea name="qna_content" id="qna_content" class="form-control" rows="8">${updateData.qna_content}</textarea>
								</td>
							</tr>
			...
			<div class="contentBtn text-right">
				...
				<input type="button" value="등록" id="qnaListBtn" class="btn btn-success"/>
			</div>
		</div>
	</body>
</html>