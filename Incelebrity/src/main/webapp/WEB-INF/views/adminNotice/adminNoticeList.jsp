...
<html lang="ko">
	<head>
		...
		<script type="text/javascript">
	    	...
	    	function selChange() {
	    	      ...
	    	      location.href="adminNoticeList?nowPage=${paging.nowPage}&cntPerPage="+sel;
	    	   }
		</script>
	</head>
	<body>
   ...
   <%--======================검색 기능 종료====================== --%>
      ...
      <c:if test="${paging.startPage != 1 }">
         <a href="/adminNotice/adminNoticeList?nowPage=${paging.startPage - 1 }&cntPerPage=${paging.cntPerPage}">&lt;</a>
      </c:if>
      <c:forEach begin="${paging.startPage }" end="${paging.endPage }" var="p">
         <c:choose>
            ...
            <c:when test="${p != paging.nowPage }">
               <a href="/adminNotice/adminNoticeList?nowPage=${p }&cntPerPage=${paging.cntPerPage}">${p }</a>
            </c:when>
         </c:choose>
      </c:forEach>
      <c:if test="${paging.endPage != paging.lastPage}">
         <a href="/adminNotice/adminNoticeList?nowPage=${paging.endPage+1 }&cntPerPage=${paging.cntPerPage}">&gt;</a>
      </c:if>
   </div>
	</body>
</html>