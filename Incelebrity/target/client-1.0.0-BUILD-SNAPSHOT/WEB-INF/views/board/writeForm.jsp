		...
		<script type="text/javascript">
			$(function(){
				...
				$("#boardInsertBtn").click(function(){
					...
					else if(!chkData("#b_title", "글제목을")) return;
					else if(!chkData("#b_content", "글내용을")) return;
				...
				<form id="f_writeForm" name="f_writeForm" class="form-horizontal">
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								<td>비밀번호</td>
								<td class="text-left"><input type="password" name="b_pwd" id="b_pwd" class="form-control" maxlength="20"></td>
							</tr>
						</tbody>
					</table>
